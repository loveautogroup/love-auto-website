...
// The APR is the data; the label is looked up per locale at render time.
const CREDIT_TIERS = [
  { key: "creditExcellent", apr: 0.0549 },
  { key: "creditGood", apr: 0.0699 },
  { key: "creditFair", apr: 0.0999 },
  { key: "creditRebuilding", apr: 0.1499 },
] as const;
