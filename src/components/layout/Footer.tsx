    ...
    <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Carefully selected, fully reconditioned, and thoroughly inspected
              quality used vehicles. Family owned in Villa Park, IL since 2014.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">{SITE_CONFIG.address.full}</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${SITE_CONFIG.phoneRaw}`} className="text-gray-400 hover:text-white transition-colors">
                  {SITE_CONFIG.phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
          ...
          {/* Hours */}
          <div>
            <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">Business Hours</h3>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-500">
          <span>&copy; {currentYear} Love Auto Group. All rights reserved.</span>
