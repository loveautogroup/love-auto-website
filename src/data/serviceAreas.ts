...
export const SERVICE_AREAS: ServiceAreaContent[] = [
  ...
  },
  {
    ...
    description:
      "Used cars for Westmont, IL drivers. Family-owned independent dealer with free Carfax, in Villa Park since 2014. Quick drive north on Cass Avenue.",
    proximity: "About 10 minutes north via Cass Avenue or Ogden Avenue.",
    intro:
      "Love Auto Group is one of the closest family-owned independent dealers to Westmont, IL — about a 10-minute drive north via Cass Avenue. We're Carfax Advantage accredited, family owned since 2014, and have built a reputation among Westmont buyers as the go-to spot for used Subaru, Lexus, Acura, Mazda, and Honda when the franchise option doesn't fit.",
    sections: [
      {
        heading: "Why Westmont Residents Drive North",
        body: [
          "Westmont's used-car options inside town are limited, and most local buyers either go to a franchise dealer in Oak Brook or Lombard or drive farther west to chains like CarMax. We're a third path — small, family-run, focused on the makes that hold their value, and run by people who actually know the cars they sell.",
  ...
  },
  {
    ...
    description:
      "Used cars for Elmhurst, IL buyers. Family-owned independent dealer, free Carfax, since 2014. Quick drive west on North Avenue from downtown Elmhurst.",
    proximity: "About 8 minutes west via North Avenue (Route 64).",
    intro:
      "Elmhurst residents who want a smaller, more curated used-car shopping experience than the franchise dealers along Roosevelt Road consistently make the short drive west to Love Auto Group in Villa Park. We've been a family-owned independent dealer since 2014, and our Elmhurst customers tell us the same thing again and again: it's worth the 8-minute drive to deal with people who actually know the cars.",
    sections: [
      {
  ...
  },
  {
    ...
    description:
      "Quality used cars for Oak Brook, IL buyers. luxury specialists — Lexus, Acura, plus Subaru, Mazda, Honda. Free Carfax, family owned since 2014.",
    proximity: "About 12 minutes north via Route 83 or York Road.",
    intro:
      "Love Auto Group serves Oak Brook, IL buyers with a curated selection of used vehicles — including a steady rotation of Lexus and Acura inventory that gives Oak Brook luxury shoppers a real alternative to the franchise dealers along the Tri-State Tollway corridor. We're family owned, Carfax Advantage accredited, and have been quietly building a Western Suburbs reputation since 2014.",
    sections: [
      {
      ...
      {
        heading: "Beyond Luxury — The Full Lineup",
        body: [
          "We're also a strong source for Subaru AWD vehicles for Oak Brook families with kids in north-suburb sports leagues, Mazda CX-5 and CX-30 for buyers who care about driving feel, and Honda Pilot and Odyssey for family duty. Whatever brand you're shopping, we're worth a look.",
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "Used cars for Glen Ellyn, IL drivers. Family-owned independent dealer, free Carfax, in Villa Park since 2014. Quick drive east on Roosevelt or North Avenue.",
    proximity: "About 12 minutes east via Roosevelt Road or North Avenue.",
    intro:
      "Love Auto Group is the closest family-owned independent dealer to Glen Ellyn, IL — about a 12-minute drive east from most of town. We've been family-owned and Carfax Advantage accredited since 2014, and Glen Ellyn buyers regularly make the trip when they're shopping used Subaru, Lexus, Acura, Mazda, or Honda.",
    sections: [
      {
  ...
  },
  {
    ...
    description:
      "Quality used cars for Addison, IL buyers. Family-owned independent dealer, free Carfax, since 2014. Easy 7-minute drive south on Lake Street.",
    proximity: "About 7 minutes south via Lake Street or Addison Road.",
    intro:
      "Love Auto Group is one of the closest independent used-car dealers to Addison, IL — about a 7-minute drive south. We carry quality used vehicles, are Carfax Advantage accredited, and have been family-owned in Villa Park since 2014.",
    sections: [
      {
        heading: "Why Addison Buyers Drive South",
        body: [
          "Addison has limited independent used-car options inside town. Most local shoppers either buy from a franchise dealer (which means paying for a brand the dealer chose, not the brand you wanted) or drive to a chain like CarMax (which means dealing with a national pricing engine and no one who actually knows your car). We're the third option — a small, family-run independent that is a family-owned independent dealer and treats every customer like a neighbor.",
          "For an Addison buyer shopping a used Subaru Outback for AWD winter security, a Honda Civic for commuting fuel economy, a Lexus RX as a smart luxury alternative, or anything else from the lineup, we're worth the short drive.",
        ],
      },
      {
        heading: "The Carfax Advantage Standard",
