...
export const translations = {
  en: {
    ...
    creditApp: {
      ...
      vehiclePick: "Which vehicle are you applying for?",
      vehiclePickPlaceholder: "Choose from our current inventory",
      vehiclePickOther: "Another vehicle / not listed",
      vehiclePickLoading: "Loading inventory…",
      vehiclePickSalePending: "sale pending",
      vehiclePickOtherText: "Tell us what you're looking for",
      desiredMonthly: "Desired monthly payment",
      downPayment: "Down payment",
      loanAmount: "Loan amount you'd like to finance",
    ...
    prequalify: {
      ...
      vehiclePick: "Which vehicle are you interested in?",
      vehiclePickPlaceholder: "Choose from our current inventory",
      vehiclePickOther: "Another vehicle / not listed",
      vehiclePickLoading: "Loading inventory…",
      vehiclePickSalePending: "sale pending",
  ...
  es: {
    ...
    creditApp: {
      ...
      vehiclePick: "¿Para qué vehículo estás aplicando?",
      vehiclePickPlaceholder: "Elige de nuestro inventario actual",
      vehiclePickOther: "Otro vehículo / no está en la lista",
      vehiclePickLoading: "Cargando inventario…",
      vehiclePickSalePending: "venta pendiente",
      vehiclePickOtherText: "Cuéntanos qué buscas",
      desiredMonthly: "Pago mensual deseado",
      downPayment: "Enganche",
      loanAmount: "Monto del préstamo que desea financiar",
    ...
    prequalify: {
      ...
      vehiclePick: "¿Qué vehículo te interesa?",
      vehiclePickPlaceholder: "Elige de nuestro inventario actual",
      vehiclePickOther: "Otro vehículo / no está en la lista",
      vehiclePickLoading: "Cargando inventario…",
      vehiclePickSalePending: "venta pendiente",
