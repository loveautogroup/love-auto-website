...
export const metadata: Metadata = {
  title: "Free Carfax Reports | Love Auto Group, Villa Park IL",
  description:
    "Carfax Advantage Dealer in Villa Park, IL. Free Carfax history reports on vehicles that show the CARFAX badge. Family owned since 2014.",
  alternates: { canonical: "https://www.loveautogroup.net/free-carfax-villa-park/" },
  openGraph: {
    title: "Free Carfax Reports | Love Auto Group, Villa Park IL",
    description:
      "Carfax Advantage Dealer in Villa Park, IL. Free Carfax history reports on vehicles that show the CARFAX badge.",
...
export default function FreeCarfaxLanding() {
  return (
    <>
      ...
      {/* Breadcrumb */}
      <SiteBreadcrumb trail={[{ label: "Free Carfax Reports" }]} />
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-[1fr_auto] items-center gap-8">
          <div>
            <h1 className="text-3xl md:text-5xl font-bold leading-tight">
              Free Carfax Reports —
              <span className="block text-brand-red mt-2">No Signup Required</span>
            </h1>
            <p className="mt-4 text-lg md:text-xl text-brand-gray-300 max-w-2xl">
              Love Auto Group is a Carfax Advantage Dealer. Vehicles in our Villa Park, IL inventory that show the CARFAX badge on their listing come with a free Carfax history report you can pull directly — no email signup, no haggling.
            </p>
          </div>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-brand-gray-700 leading-relaxed mb-4">
          Carfax Advantage Dealer is an accreditation program — Carfax independently verifies that a dealer reports vehicle service activity, accident records, and ownership history into the Carfax database, and requires the dealer to make a free Carfax history report available across its inventory. It's not a self-claimed badge. Carfax has to confirm we meet the standard.
        </p>
        ...
        <p className="text-brand-gray-700 leading-relaxed mb-8">
          That's the same report that costs around $40 to pull as a private buyer on the Carfax website. We provide it for free on the vehicles that show the CARFAX badge.
        </p>
        ...
        <p className="text-brand-gray-700 leading-relaxed">
          Our Carfax Advantage status means that history is available to shoppers looking at vehicles that show the CARFAX badge, on the lot or on our website. That's the kind of dealer we are. That's the kind of buying experience our customers tell us they want.
        </p>
      </article>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-12">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-brand-gray-900">
            Browse Inventory — Free Carfax on Marked Listings
          </h2>
        </div>
        <LivePreviewGrid />
